...
<img src="assets/ux/wireframe.png" alt="wireframe" title="Wireframe of Ogham mapping project" width="150" height="300">
...
After I had started the project, and realised the fault of the wireframe design, I edited my design using Canva, to create a more detailed mock up of the website. This enabled me to test the details such as fonts, imagery etc, in more detail.
    ...
    <img src="ux/mock-up.png" alt="ogham- mapping mock up" title="ogham- mapping mock up" width="150" height="300">
...
* <a href="https://github.com">Github</a> ~ Github is where I am hosting my deployed website which you can view here:
*API ~ Google Maps 
*iFrames ~ using Sketchfab embedded iframe, manipulated through CSS

#### Tools Used:
* <a href="https://balsamiq.com/">Balsamiq</a> ~ used to create the wireframe
* <a href="https://canva.com/">Canva</a> ~ used to create the mockup
...
*Google Maps API ~ manipulated to create locations of stones
*EmailJs ~ create usable contact form

#### Code Validation:
I used  few online validators to check the code at regular intervals throughout the build.
